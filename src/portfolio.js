...
const skillsSection = {
  ...
  skills: [
    emoji(
      "⚡ Design and develop immersive games and simulations for various platforms"
    ),
    emoji("⚡ Create interactive and engaging gameplay mechanics for unique player experiences"),
    emoji(
      "⚡ Develop VR and AR applications with cutting-edge technologies"
    ),
    emoji(
      "⚡ Continuously innovate to push the boundaries of interactive entertainment"
    ),
  ],
  ...
  schools: [
    {
      ...
      logo: require("./assets/images/Necmettin_Erbakan_Üniversitesi_logosu.png"),
